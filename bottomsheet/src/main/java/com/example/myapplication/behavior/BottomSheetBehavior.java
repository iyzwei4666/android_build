...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public Parcelable onSaveInstanceState(CoordinatorLayout parent, V child) {
        return new  BottomSheetBehavior.SavedState(super.onSaveInstanceState(parent, child), mState);
    }
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            if (mViewDragHelper.settleCapturedViewAt(releasedChild.getLeft(), top)) {
                ...
                ViewCompat.postOnAnimation(releasedChild,
                        new  BottomSheetBehavior.SettleRunnable(releasedChild, targetState));
            } else {
                setStateInternal(targetState);
            }
        }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public static final Creator< BottomSheetBehavior.SavedState> CREATOR = ParcelableCompat.newCreator(
                new ParcelableCompatCreatorCallbacks< BottomSheetBehavior.SavedState>() {
                    @Override
