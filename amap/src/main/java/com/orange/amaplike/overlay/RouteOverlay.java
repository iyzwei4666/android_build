...
public class RouteOverlay {
	...
	public void zoomToSpan2() {
		if (startPoint != null) {
			...
			try {
				...
				mAMap.animateCamera(CameraUpdateFactory
						.newLatLngBoundsRect(bounds,50,50,300,100));
			} catch (Throwable e) {
				e.printStackTrace();
			}
		}
	...
	public void zoomWithPadding(int paddingTop,int paddingBottom) {
		if (startPoint != null) {
			if (mAMap == null)
				return;
			try {
				...
				//newLatLngBoundsRect(LatLngBounds latlngbounds, int paddingLeft, int paddingRight, int paddingTop, int paddingBottom)
				mAMap.animateCamera(CameraUpdateFactory
						.newLatLngBoundsRect(bounds,50,50,50+paddingTop,50+paddingBottom));
			} catch (Throwable e) {
				e.printStackTrace();
			}
		}
	...
	public void zoomToBusSpan(int paddingbottom) {
		Log.d("czh","zoom:"+paddingbottom);
		if (startPoint != null) {
			if (mAMap == null)
				return;
			try {
				...
				//newLatLngBoundsRect(LatLngBounds latlngbounds, int paddingLeft, int paddingRight, int paddingTop, int paddingBottom)
				mAMap.animateCamera(CameraUpdateFactory
						.newLatLngBoundsRect(bounds,80,80,80,50+paddingbottom));
			} catch (Throwable e) {
				e.printStackTrace();
			}
		}
	...
	protected int getRideColor(){return Color.parseColor("#537edc");}
